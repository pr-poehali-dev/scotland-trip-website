  ...
  const reviews = [
    {
      name: "Мария К.",
      location: "Москва",
      text: "Невероятное путешествие! Тима и Тёма показали нам настоящую Шотландию - от древних замков до горных вершин. Профессионально и с душой!",
      rating: 5,
    ...
    },
    {
      name: "Андрей С.", 
      location: "СПб",
      text: "Горные маршруты были потрясающими! Отличная организация, комфортные ночевки и незабываемые виды. Рекомендую всем любителям активного отдыха.",
      rating: 5,
    ...
    },
    {
      name: "Елена В.",
      location: "Казань", 
      text: "Эдинбург покорил с первого взгляда! Спасибо ребятам за интересные истории и отличную программу. Уже планируем следующую поездку!",
      rating: 5,
